...
class Product {
    ...
    const IMG_BASE_PATH = '/angular_mz/app/img/';
    const MAX_CSS_WIDTH_CLASS = 1; // 1..4

    protected static $colors = array('#8E44AD', '#F39C12', '#D35400', '#006A3F', '#2980B9', '#C0392B', '#956DC9', '#27AE60');
    protected static $imgs = array('product1.jpg', 'product2.jpg', 'product3.jpg', 'product4.jpg', 'product5.jpg');
    ...
    public function getNewRandom()
    {
        ...
        $this->img = self::IMG_BASE_PATH . self::$imgs[rand(0, count(self::$imgs) - 1)];
